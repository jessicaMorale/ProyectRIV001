...
def show_documents_table(docs, processed_docs, num_docs=100):
    ...
    Args:
        docs (list): Lista de documentos originales
        processed_docs (list): Lista de documentos preprocesados
        num_docs (int): Número de documentos a mostrar (por defecto 100)
    """
